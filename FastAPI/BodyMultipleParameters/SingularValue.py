...
async def update_item(
    ...
    """
    Update an item using a path parameter and multiple request body inputs.

    This endpoint demonstrates how to:
    - Use multiple Pydantic models in the request body (Item and User)
    - Add an additional body parameter using Annotated and Body()
    ...
    importance : int
        An additional value sent in the request body using Body().

    Returns
    -------
    dict
        A dictionary containing the item_id, item data, user data,
